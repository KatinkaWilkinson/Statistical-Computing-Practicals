...
summary(m1)
m1.beta.stats <- summary(m1)$coefficients
beta.stats.lm <- list('beta' = m1.beta.stats[,1], 'SE' = m1.beta.stats[,2], 'tstat' = m1.beta.stats[,3], 'pval' = m1.beta.stats[,4])
print(beta.stats.lm)
print(beta.stats.manual)
identical(beta.stats.manual, beta.stats.lm)
```
